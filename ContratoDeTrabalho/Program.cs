        ...
        static void Main(string[] args)
        {
            ...
            var contrato = new
            {
                Empresa = new
                {
                    ...
                    CNPJ = new CNPJFormatter().Format("44708099000156"),
                ...
                {
                    Nome = "Mario Mario",
                    CPF = new CPFFormatter().Format("86662522864"),
                    RG = "479378344",
                    Nacionalidade = "italiano",
                    EstadoCivil = "casado",
                    Endereco = viaCEP.GetEndereco("07084182"),
                    Numero = "146"
                },
                Inicio = new DateTime(2021, 01, 15).ToString("d", new CultureInfo("pt-BR")),
                InicioExtenso = DateTime.Today.ToString("D"),
                Cargo = "Encanador",
            ...
            Cláusula 1ª - O EMPREGADO prestará ao EMPREGADOR, a partir de {contrato.Inicio} e assinatura deste instrumento, seus trabalhos exercendo a função de {contrato.Cargo}, prestando pessoalmente o labor diário no período compreendido entre 9 horas às 18 horas, e intervalo de 1(uma) hora para almoço;

            Cláusula 2ª - Não haverá expediente nos dias de sábado, sendo prestado a compensação de horário semanal;

            Cláusula 3ª - O EMPREGADOR pagará mensalmente, ao EMPREGADO, a título de salário a importância de {contrato.Salario.ToString("C", new CultureInfo("pt-BR"))} ({contrato.Salario.Extenso()}), com os descontos previstos por lei;
            ...
            {contrato.Empresa.Endereco.Localidade}, {contrato.InicioExtenso}
